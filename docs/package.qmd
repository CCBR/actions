...
However, you can [install the package](/install.qmd)
if you wish to use it outside of GitHub Actions or contribute changes.

See detailed usage information in the [API reference](/reference/index.html).
