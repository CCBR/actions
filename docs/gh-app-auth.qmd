...
The [CCBR Bot](http://github.com/apps/CCBR-bot) is a GitHub App that provides secure authentication for automated workflows without requiring personal access tokens. This approach offers better security, granular permissions, and easier token management for organization-wide automation.
...
- **`CCBR_BOT_APP_PRIVATE_KEY`** (secret): The GitHub App private key
