...
This action must run on a host runner, not in a job `container`: it
provisions R and pandoc with
[`r-lib/actions`](https://github.com/r-lib/actions), which requires
`sudo`.
